...
REM
REM Generated by Vivado on Sat Nov 18 23:22:45 -0500 2023
...
echo "xvhdl --incr --relax -prj Cipher_tb_vhdl.prj"
call xvhdl  --incr --relax -prj Cipher_tb_vhdl.prj -log xvhdl.log
